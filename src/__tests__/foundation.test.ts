...
import { ToolDispatcher, toolRegistry } from "../tools/registry";
...
describe("JARVIS Phase 1 Architecture & Foundation", () => {
  ...
  describe("Security & Tool Permission Registry", () => {
    ...
    it("blocks unapproved execution of sensitive tools", () => {
      ...
      // Tool is not implemented in Phase 1 AND requires human approval
  ...
  describe("Logger Sanitization", () => {
    it("redacts sensitive fields like passwords, secrets, tokens, and api keys", () => {
      ...
      const nested = sanitized.sessionData as Record<string, unknown>;
