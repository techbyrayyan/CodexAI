            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs font-mono">
                ...
                <div className="p-3 rounded-lg bg-zinc-900 border border-zinc-800">
                  ...
                  <span className="text-emerald-400 font-bold">JavaScript / Next.js 16</span>
                </div>
                <div className="p-3 rounded-lg bg-zinc-900 border border-zinc-800">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="p-3 rounded-lg bg-zinc-900/80 border border-zinc-800 text-xs text-zinc-400">
                ...
                <code className="text-emerald-400 font-mono">src/ai/agents/base.js</code>.
              </div>
            </CardContent>
          </Card>
        </TabsContent>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <p className="text-xs text-zinc-400 leading-relaxed">
                ...
                <code className="text-emerald-400 font-mono">src/ai/realtime/types.js</code>. The
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <p className="text-xs text-zinc-400 leading-relaxed">
                ...
                and memory contracts (<code className="text-emerald-400 font-mono">src/ai/memory/types.js</code>)
        ...
        <TabsContent value="local_agent">
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <p className="text-xs text-zinc-400 leading-relaxed">
                The client communication contract (<code className="text-emerald-400 font-mono">src/services/local-agent.js</code>)
