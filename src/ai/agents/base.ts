import { AgentContext, AgentMessage, AgentResponse, AgentRole, JarvisState } from "../types";
...
export class JarvisCoreAgent extends BaseAgent {
  ...
  async process(input: string, context: AgentContext): Promise<AgentResponse> {
    logger.info("JarvisCoreAgent processing input", { role: this.role, inputLength: input.length });
